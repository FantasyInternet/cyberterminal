(module
  ...
  (func $loadSleepyhead (param $w i32) (param $h i32) (param $req i32)
    ...
    (if (i32.eq (get_local $req) (get_global $pointerReq)) (then
      ...
      (set_global $pointer (call $createPart (i32.mul (i32.const 4) (i32.mul (get_global $pointerW) (get_global $pointerH)))))
      (call $popToMemory (call $getPartOffset (get_global $pointer)))
    ))
  )
  ...
  (func $draw (param $t f64)
    ...
    (call $drawImage (get_global $pointer) (call $getMouseX) (call $getMouseY) (get_global $pointerW) (get_global $pointerH))
  ...
  (func $drawImage (param $img i32) (param $x i32) (param $y i32) (param $w i32) (param $h i32)
    ...
    (local $j i32)
    (local $k i32)
    (set_local $imgWidth (get_local $w))
    (br_if 0 (i32.ge_s (get_local $x) (get_global $displayWidth)))
    (br_if 0 (i32.ge_s (get_local $y) (get_global $displayHeight)))
    (br_if 0 (i32.lt_s (i32.add (get_local $x) (get_local $w)) (i32.const 0)))
    (br_if 0 (i32.lt_s (i32.add (get_local $y) (get_local $h)) (i32.const 0)))
    ...
    (block (loop
      ...
      (set_local $i (i32.sub (i32.add (get_local $i) (i32.mul (i32.const 4) (get_global $displayWidth))) (i32.mul (i32.const 4) (get_local $w))))
      (set_local $k (i32.sub (i32.add (get_local $k) (i32.mul (i32.const 4) (get_local $imgWidth))) (i32.mul (i32.const 4) (get_local $w))))
      (set_local $h (i32.sub (get_local $h) (i32.const 1)))
      (br 0)
    ))
  )
