(module
  ...
  (func $step (param $t f64)
    ...
    (set_global $x (i32.add (get_global $x) (i32.trunc_s/f32 (f32.nearest (call $getGameAxisX)))))
    (set_global $y (i32.add (get_global $y) (i32.trunc_s/f32 (f32.nearest (call $getGameAxisY)))))
    ...
    ;;(if (i32.eq (get_global $x) (i32.const 0)) 
  ...
  (func $pset (param $x i32) (param $y i32) (param $r i32) (param $g i32) (param $b i32)
    ...
    (i32.store8 (i32.add (get_local $displayOffset) (i32.add (get_local $i) (i32.const 0))) (get_local $r))
    (i32.store8 (i32.add (get_local $displayOffset) (i32.add (get_local $i) (i32.const 1))) (get_local $g))
    (i32.store8 (i32.add (get_local $displayOffset) (i32.add (get_local $i) (i32.const 2))) (get_local $b))
    (i32.store8 (i32.add (get_local $displayOffset) (i32.add (get_local $i) (i32.const 3))) (i32.const 255))
  )
)