(module
  ...
  (import "env" "startTone" (func $startTone (param i32) (param i32) ))
  (import "env" "stopTone" (func $stopTone (param i32) ))
  (import "env" "readImage" (func $readImage (param i32) (result i32)))
